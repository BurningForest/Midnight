...
namespace Midnight.ChiefOperations
{
    public class Io : IIo
    {
        ...
        public Status Attack(Target command)
        {
            ...
            var fieldCard = target as FieldCard;
            return card != null && fieldCard != null
                ? _manage.Fight(card, fieldCard).GetStatus()
        ...
        public Status Order(Target command)
        {
            ...
            var card = target as FieldCard;
            return order != null && card != null
                ? _manage.Order(order, card).GetStatus()
                : Status.WrongCardType;
        }
